  ...
  return (
    <div className="container mx-auto p-4 md:p-8 min-h-screen bg-background">
      <header className="mb-8 justify-center flex flex-col items-center text-center">
        <h1 className="text-3xl font-bold flex items-center">Pengumuman</h1>
        <p className="text-muted-foreground mt-2">
          Informasi terbaru dan pengumuman penting seputar Planify.
        </p>
      </header>
      <div className="space-y-6 max-w-3xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            ...
            <CardContent>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  ...
                  mengekstrak daftar mata kuliah dari file PDF atau gambar
                  jadwal kampusmu.
                </li>
                <li>
          ...
          <Card>
            ...
            <CardContent>
              <p className="mb-4">
                Masukanmu sangat berharga untuk pengembangan Planify ke
                depannya. Jika memiliki ide fitur baru atau menemukan bug,
                jangan ragu untuk memberi tahu.
              </p>
              <p className="mb-4">
                Bisa mengirimkan saran atau laporan bug melalui formulir
                berikut:
              </p>
              <Link
        ...
        <div className="grid grid-cols-1">
          <Card>
            ...
            <CardContent>
              <p className="mb-4">
                Bisa melihat contoh data dummy mata kuliah yang dapat digunakan
                di Planify melalui link berikut:
              </p>
              <Link
              ...
              <p className="mb-4">
                ...
                bisa mengirimkannya melalui link di bawah ini. Kontribusimu
                sangat membantu pengembangan Planify ke depannya.
              </p>
              <Link
